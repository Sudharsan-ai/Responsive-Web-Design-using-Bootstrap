...
<head>
    ...
    <link rel="icon" href="https://image.similarpng.com/very-thumbnail/2020/07/Pharmacy-logo-on-transparent-PNG.png">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body background="https://imgs.search.brave.com/sGyIhqYtjeqeV2I50GWVUYD_vAjZwQXMQcpgtlco1v8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by90/b3Atdmlldy1tZWRp/Y2luZS1ibHVlLWJh/Y2tncm91bmRfMjMt/MjE0OTM0MTU2OS5q/cGc_c2VtdD1haXNf/aHlicmlk" style="background-repeat: no-repeat; background-size: cover;">

    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="service.html">ZnZ Pharmacy</a>
    ...
    <div class="bg-primary text-white text-center py-1">
        <div class="container">
            <h1>Welcome to ZnZ Pharmacy</h1>
            <p>Your health, our priority.</p>
            <a href="service.html" class="btn btn-light btn-lg">Explore Services</a>
        </div>
    </div>
    ...
    <footer style="font-size: large;"><center>
      <br><br><p style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">&copy; 2024 PharmEasy. All rights reserved. by Sudharsan s</p>
       </footer></center>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">ZnZ PharmEasy</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
  ...
  <footer><center>
    <br><br><br><br><br><p style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">&copy; 2024 PharmEasy. All rights reserved. by Sudharsan s</p>
   </footer></center>
...
<body>
  ...
  <footer style="font-size: large; color: aliceblue;"><center>
   <br><br><br><br><br><br><br> <p style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">&copy; 2024 PharmEasy. All rights reserved. by Sudharsan S</p>
  </footer></center>
